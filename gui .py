...
def book():
    ...
    #booklist=Button(frame2,text="SHOW COMPLETE DETAILS OF THE BOOK",command=showbookdetails).grid(row=0,column=2)
#-------------------------------------------------------------------------------------------------------------
...
def makenew():
        ...
        frame3=Frame(root)
        frame3.pack()
        book=Button(frame1,text="BOOKS",command=book).grid(row=0,column=0)
        student=Button(frame1,text="STUDENTS",command=student).grid(row=0,column=1)
